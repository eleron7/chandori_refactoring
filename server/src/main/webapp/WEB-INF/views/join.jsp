...
<div class="container">
    <form class="form-signin" id='join_form'>
        ...
        <p>
            ...
            <input type="text" id="job" name="job" class="form-control" placeholder="직업" required="">
        </p>
        <p>
            <label for="income" class="sr-only">수입</label>
            <input type="text" id="income" name="income" class="form-control" placeholder="수입액" required="">
        </p>
